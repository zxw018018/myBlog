# sumo logic
## [needle_haystack](#implement-strstr)
## [binary_tree_common](#lowest-common-ancestor-of-a-binary-tree)
## [group_anagram](#group-anagrams)
## [decode_ways](#decode-ways)
## [simplify_path](#simplify-path)
## [longest_palindrome](#find-longest-palindrome-in-string)
## [circular_queue_using_array](#design-circular-queue-using-array)
## [word_search](#word-search)
## [find_peak_value](#find-peak-value)
## [find_longest_substring_without_repeating_characters](#find-longest-substring-without-repeating-characters)
## [min_stack](#min-stack)
...
class Solution {
    public int strStr(String haystack, String needle) {
        ...
        for (int i = 0; i < haystackLen - needleLen + 1; i++) {
            int haystackIndex = i;
            int needleIndex = 0;
            while (haystackIndex < haystackLen && needleIndex < needleLen 
